...
public class CountryCardAdapter extends RecyclerView.Adapter<CountryCardAdapter.CountryCardViewHolder> {

    private List<CountryModel> countryList;

    public CountryCardAdapter(List<CountryModel> countryList) {
    ...
    public static class CountryCardViewHolder extends RecyclerView.ViewHolder {
        ...
        public CountryCardViewHolder(View v){
            super(v);
            vName = (TextView) v.findViewById(R.id.country_name);
        }
    }
}
