...
public class CustomFontUtils {
    ...
    private static Typeface selectTypeface(Context context, String fontName, int textStyle) {
        if (fontName.contentEquals(context.getString(R.string.font_name_neue_haas))) {
            /*
            ...
            */
            switch (textStyle) {
                case Typeface.BOLD: // bold
                    return FontCache.getTypeface("NeueHaasGrotDisp-Bold.ttf", context);
                case 10: // Medium, equals @integer/font_style_extra_light
                    return FontCache.getTypeface("NeueHaasGrotDisp-Medium.ttf", context);
                case Typeface.NORMAL: // regular
                    return FontCache.getTypeface("NeueHaasGrotDisp-Roman.ttf", context);
                default:
                    return FontCache.getTypeface("NeueHaasGrotDisp-Roman.ttf", context);
            }
        }
